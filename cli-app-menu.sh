...
f_menu_app_music_players () {
      ...
      do    # Start of Music Player Applications until loop.
            ...
            case $CHOICE_APP in # Start of Music Player Applications case statement.
                 ...
                 f_application_run
                 ;;
                 12 | [Pp] | [Pp][Ii] | [Pp][Ii][Aa] | [Pp][Ii][Aa][Nn] | [Pp][Ii][Aa][Nn][Oo] | [Pp][Ii][Aa][Nn][Oo][Bb] | [Pp][Ii][Aa][Nn][Oo][Bb][Aa] | [Pp][Ii][Aa][Nn][Oo][Bb][Aa][Rr])
                 APP_NAME="pianobar"
                 f_application_run
                 ;;
                 pianobar' '*)
                 ...
                 f_application_run
                 ;;
                 13 | [Pp] | [Pp][Yy] | [Pp][Yy][Tt] | [Pp][Yy][Tt][Oo] | [Pp][Yy][Tt][Oo][Nn] | [Pp][Yy][Tt][Oo][Nn][Ee])
                 APP_NAME="pytone"
                 f_application_run
                 ;;
                 pytone' '*)
                 ...
                 f_application_run
                 ;;
                 14 | [Ss] | [Ss][Hh] | [Ss][Hh][Ee] | [Ss][Hh][Ee][Ll] | [Ss][Hh][Ee][Ll][Ll] | [Ss][Hh][Ee][Ll][Ll][-] | [Ss][Hh][Ee][Ll][Ll][-][Ff] | [Ss][Hh][Ee][Ll][Ll][-][Ff][Mm])
                 APP_NAME="shell-fm"
                 f_application_run
                 ;;
                 shell-fm' '*)
                 ...
                 f_application_run
                 ;;
                 16 | [Yy] | [Yy][Aa] | [Yy][Aa][Uu] | [Yy][Aa][Uu][Aa] | [Yy][Aa][Uu][Aa][Pp])
                 APP_NAME="yauap"
                 f_application_run
                 ;;
                 yauap' '*)
...
#
# +----------------------------------------+
# |    Function f_menu_file_compression    |
# +----------------------------------------+
#
#  Inputs: None. 
#    Uses: CHOICE_APP, MAX.
...
} # End of function f_menu_file_compression
#
# +----------------------------------------+
